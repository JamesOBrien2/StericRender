...
| 1 PCy3, 29.62 [ref] | 2 NHC-Ni, 36.10 | 3 NHC-Ir, 43.93 |
|---|---|---|
...
| 4 MeDuPhos, 46.90 [ref] | 5 Box, 43.80 [ref] | 6 Diphosphine, 53.86 |
|---|---|---|
...
| 7 PHOX, 49.10 | 8 Xantphos, 52.69 | 9 Diimine, 47.72 |
|---|---|---|
...
| 10 TADDOL, 40.14 | 11 BINOL, 35.90 | 12 Bipy, 36.10 |
|---|---|---|
...
| 13 Salen-Mn, 64.20 [ref] | 14 Chiral salen-Mn, 65.37 [ref] | 15 Zr-ONNO, 60.41 [ref] |
|---|---|---|
...
| 16 C2 zirconocene, 64.83 | 17 Substituted zirconocene, 66.73 | 18 Cs zirconocene, 64.02 |
|---|---|---|
...
`--include-hydrogens`, `--sphere-radius`, `--mesh`, `--config`,
`--overlay-opacity`, `--no-contours`, `--no-colorbar`, `--no-overlay`.
